window.addEventListener('load', function(){
    ...
    class InputHandler{
        constructor(game){
            window.addEventListener('keydown', e => {
                if(((e.key.toUpperCase() === 'W') || e.key.toUpperCase() === 'S') && game.keys.indexOf(e.key) === -1){
    ...
    class Player{
        ...
        update(deltaTime){
            if(game.keys.includes('w')) this.speedY = -this.maxSpeed;
            else if(game.keys.includes('s')) this.speedY = this.maxSpeed;
            else this.speedY = 0;
            this.y += this.speedY;
            //  Vertical Boundaries
